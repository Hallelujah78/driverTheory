                        ...
                        <tr>
                          <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank" href=${origin}
                              style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#134F5C;font-size:14px"><img
                                class="adapt-img"
                                src="https://res.cloudinary.com/duar7ipaf/image/upload/v1684452108/logoSVG_jupu7j.png"
                                alt="Logo"
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                        ...
                        <tr>
                          <td align="center" style="padding:0;Margin:0;font-size:0px"><img
                              src="https://res.cloudinary.com/duar7ipaf/image/upload/v1684418443/icons8-lock-100_1_o96pnt.png"
                              alt
                              style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                              width="100"></td>
                        </tr>
                        ...
                        <tr>
                          <td align="center" class="es-m-p0r"
                            ...
                            <p
                              ...
                              ${name},
                              you are receiving this message because you requested that your password be reset.</p>
                            <p
                              style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px">
                              <br>
                            </p>
                            <p
                              style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px">
                              You can reset your password by clicking on the button below.</p>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" class="es-m-txt-c"
                        ...
                        <tr>
                          <td align="center" class="es-m-txt-l"
                            style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><!--[if mso]><a href=${resetPasswordLink} target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href=${resetPasswordLink} 
                              ...
                              <tr>
                                <td align="center" valign="top" style="padding:0;Margin:0;padding-right:30px"><a
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#134F5C;font-size:12px"><img
                                      title="Facebook"
                                      src="https://res.cloudinary.com/duar7ipaf/image/upload/v1684414281/icons8-facebook-48_kdzmdz.png"
                                      alt="Fb" width="32"
                                ...
                                <td align="center" valign="top" style="padding:0;Margin:0;padding-right:30px"><a
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#134F5C;font-size:12px"><img
                                      title="Twitter"
                                      src="https://res.cloudinary.com/duar7ipaf/image/upload/v1684414291/icons8-twitter-48_oeawjr.png"
                                      alt="Tw" width="32"
                                      style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a>
                                </td>
                                <td align="center" valign="top" style="padding:0;Margin:0;padding-right:30px"><a
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#134F5C;font-size:12px"><img
                                      title="Instagram"
                                      src="https://res.cloudinary.com/duar7ipaf/image/upload/v1684414292/icons8-instagram-48_azcuxl.png"
                                      alt="Inst" width="32"
                                      style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a>
                                </td>
                                <td align="center" valign="top" style="padding:0;Margin:0"><a target="_blank"
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#134F5C;font-size:12px"><img
                                      title="Youtube"
                                      src="https://res.cloudinary.com/duar7ipaf/image/upload/v1684414292/icons8-youtube-48_p2e6xi.png"
                                      alt="Yt" width="32"
                                      style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"></a>
                                </td>
                              </tr>
